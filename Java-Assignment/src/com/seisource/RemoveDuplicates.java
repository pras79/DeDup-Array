...
public class RemoveDuplicates {
	...
	public static void main(String[] args) {
		 ...
		 * choosen quicksort to sort the array - time complexity O(nlog(n)) and
		 * go through the array to remove the duplicates O(n) constannt space
	...
	static int[] removeDuplicateValuesUsingStreams(int[] arrayInputValues) {
		...
		return Arrays.stream(arrayInputValues).distinct().toArray();
